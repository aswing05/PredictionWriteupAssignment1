...
```r
data <- read.csv("C:\\Users\\Aswin\\PredictionWriteupAssignment\\pml-training.csv")
#summary(data)
#describe(data)
#sapply(data, class)
#str(data)
...
```r
data <- read.csv("C:\\Users\\Aswin\\PredictionWriteupAssignment\\pml-training.csv", na.strings=c("#DIV/0!") )
```
...
## 
##                      Class: A Class: B Class: C Class: D Class: E
## Sensitivity            1.0000   0.9968   0.9906   0.9938   0.9967
## Specificity            0.9997   0.9985   0.9980   0.9990   1.0000
## Pos Pred Value         0.9993   0.9937   0.9906   0.9950   1.0000
## Neg Pred Value         1.0000   0.9992   0.9980   0.9988   0.9993
## Prevalence             0.2845   0.1935   0.1743   0.1639   0.1837
## Detection Rate         0.2845   0.1929   0.1727   0.1629   0.1831
## Detection Prevalence   0.2847   0.1941   0.1743   0.1637   0.1831
## Balanced Accuracy      0.9999   0.9977   0.9943   0.9964   0.9983
```

As seen by the result of the confusion matrix, the model is good and efficient because it has an accuracy of 0.997 and very good sensitivity & specificity values on the testing dataset. (the lowest value is 0.992 for the sensitivity of the class C)
